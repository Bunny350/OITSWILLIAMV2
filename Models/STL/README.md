...
| Tracker mount (AirTag and Galaxy SmartTag) | Tracker mount | :heavy_check_mark: Fully supported[^daretodeploy] | :heavy_check_mark: Fully supported[^daretodeploy] |
...
[^nointents]: There is no intent in extending support to Trident, V0, et cetera, but there will be for Micron Plus.
